...
function magnetism_setup() {
	...
	register_nav_menus( array(
		'menu-1' => esc_html__( 'Primary', 'magnetism' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'magnetism_custom_background_args', array(
...
function magnetism_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'magnetism_content_width', 640 );
}
...
function magnetism_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'magnetism' ),
...
function magnetism_scripts() {
	wp_enqueue_style( 'magnetism-style', get_stylesheet_uri() );

	wp_enqueue_script( 'magnetism-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'magnetism-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
